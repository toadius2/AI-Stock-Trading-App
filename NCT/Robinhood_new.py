...
class Robinhood:
    ...
    def login(self,
        ...
        if qr_code:
            ...
            try:
                ...
                print(self.challenge_id, "   ", "challenge" in response_data.keys())
                ...
                # TODO: Use a popup textbox to prompt users to enter their code
                # PROMPT USER TO ENTER MFA CODE FROM THEIR TEXT
                self.sms_code = input()
    ...
    def get_historical_quotes(self, stock, interval, span, bounds=Bounds.REGULAR):
        ...
        historicals = endpoints.historicals() + "/?symbols=" + ','.join(
            stock).upper() + "&interval=" + interval + "&span=" + span + "&bounds=" + bounds.name.lower()
