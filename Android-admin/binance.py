...
class Binance:
    ...
    def get_nonzero_currency(self):
        nonzero = []
        for item in self.account_information()[1]['balances']:
...
if __name__ == '__main__':
    bin = Binance('lISh9SeQdCT1HGPeo3Z6p8jWAsOJ6tmjoG7LeMsMNGCGBT0HRhfyfEvHJdjn49IG', 'mM57MtfNnRG1UrrZs6uGbKNNx1VIU7UktgwqPxelhXkI0cqjXaSCTOvXZY8vMTxj')
    a = bin.price_ticker('BTCUSD')['price']
    print(float(a) * 9)
